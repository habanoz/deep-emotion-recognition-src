...
def merge_models_sklearn_nb( nb_classes):
    model = GaussianNB()
    return model
...
def main():
    ...
    merged_model = merge_models_sklearn_nb(nb_classes)
    ...
    for i in range(steps_per_epoch):
        ...
        merged_model.partial_fit(X,y,classes=merged_generator_valid.class_indices.values())
