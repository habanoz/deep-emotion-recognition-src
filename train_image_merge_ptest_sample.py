...
# - simplified vggface
#
# suitable for running muliple times using run_train_image_merge_ptest_sample.sh
...
from work_image.abstract_train_cnn_base import TrainCnnConfiguration, AbstactTrainCnnBase, change_seed
...
config=TrainCnnConfiguration(data_dir=DATA_DIR, batch_size=BATCH_SIZE, dimension=DIMENSION, optimizer=OPTIMIZER,
                             perturbate_epsilon=perturbate_epsilon, weights_file=None, freeze_layer=12,
                             reduce_lr_factor=None,reduce_lr_patience=5,img_train_gen_params=img_train_gen_params ,top_epochs=8)

change_seed(None)

model_urls=['/mnt/sda2/dev_root/deep-emotion-recognition/models/1522605364.22-12593475-resnet-fer13/checkpoints/w.014-0.6121-2.29.hdf5',
