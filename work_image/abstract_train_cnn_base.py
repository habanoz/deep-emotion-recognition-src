...
FREEZE_LAYERS = None
VAL_BATCH_SIZE = 1
PERTURBATION_THRESHOLD=0.08 # if accuracy is more than this threshold perform perturbation
PERTURBATION_PERIOD=10 # re-attempt perturbation only after that many epochs
SHUFFLE=True
SEED=None
...
class TrainCnnConfiguration():
    def __init__(self, weights_file, data_dir, batch_size, dimension, optimizer, perturbate_epsilon=None,freeze_layer=None,per_class_log=False,reduce_lr_factor=None,reduce_lr_patience=None,img_train_gen_params=None,top_epochs=10):
        ...
        self.perturbate_epsilon=perturbate_epsilon
    ...
    def to_string(self):
        ...
        o = o +('perturbate_epsilon=' + str(self.perturbate_epsilon)+str('\n'))
        o = o +('per_class_log=' + str(self.per_class_log)+str('\n'))
